...
class ShopReviewSheet: UIViewController {
    ...
    @IBAction func postButtonPressed(_ sender: Any) {
        ...
        let shopReview = ShopReivew(shop: shop, coffeeType: coffeeType.coffeeTypeLabel.text!, shopTags: tagCell.selectedTags.joined(separator: ", "), rating: Int(rating)!, review: review, user: user, date: date)
